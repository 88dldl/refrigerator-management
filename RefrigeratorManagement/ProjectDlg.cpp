...
BEGIN_MESSAGE_MAP(CProjectDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TCN_SELCHANGE, IDC_TAB_MAIN, &CProjectDlg::OnSelchangeTabMain)
END_MESSAGE_MAP()
...
BOOL CProjectDlg::OnInitDialog()
{
	...
	m_tab.InsertItem(0, L"내 냉장고");
	m_tab.InsertItem(1, L"유통기한 임박했어요");
...
void CProjectDlg::OnSelchangeTabMain(NMHDR* pNMHDR, LRESULT* pResult)
{
